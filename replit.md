...
- `performance.js` is included on all pages for branded loading animation, skeleton loading, page-transition loading, image lazy-loading hints, smooth anchor scrolling, desktop inertia scrolling, scroll reveal animations, and paint/layout optimizations
