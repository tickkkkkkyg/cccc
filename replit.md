...
- `performance.js` is included on all pages for skeleton loading, image lazy-loading hints, smooth anchor scrolling, desktop inertia scrolling, scroll reveal animations, and paint/layout optimizations
